  ...
  return (
    <ScreenHOC containerStyle={styles.container} title={STRINGS.DEBIT_CARD}>
      <View style={styles.pageContainer}>
        ...
        <ScrollView
          contentContainerStyle={CommonStyles.paddingBottom(40)}
          ...
          <View style={styles.bottomView}>
            <View style={styles.showDetailContainer}>
              <TouchableOpacity
                style={styles.showDetailContainerInner}
                onPress={() => setShowCardDetails(!showCardDetails)}>
                <Octicons
                  name={showCardDetails ? 'eye-closed' : 'eye'}
                  size={15}
                  color={COLORS.SECONDARY}
                />
                <Text style={styles.showHideText}>
                  {showCardDetails
                    ? STRINGS.HIDE_CARD_NUMBER
            ...
            {weeklyLimit && (
              <View style={{marginTop: _scaleText(30).fontSize}}>
                ...
                <View style={styles.progressContainer}>
                  <View style={styles.progressBar(getBarFilledValue())} />
                </View>
              </View>
            )}
